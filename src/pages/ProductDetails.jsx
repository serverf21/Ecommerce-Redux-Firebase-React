...
const ProductDetails = () => {
  ...
  const {imgUrl, productName, price, avgRating,
     reviews, description, shortDesc, category} = product;
  ...
  const submitHandler = (e) => {
    ...
    reviewUserName ? 
    toast.success(`Review added by ${reviewUserName}`) :
                  ...
                  <div className="review__form">
                    ...
                    <form action="" onSubmit={submitHandler}>
                      ...
                      align-items-center gap-5 rating__group">
                        ...
                        onClick={() => setRating(1)}>1<i class="ri-star-fill"></i></motion.span>
                        <motion.span whileTap={{scale: 1.4}} onClick={() => setRating(2)}>2<i class="ri-star-fill"></i></motion.span>
                        <motion.span whileTap={{scale: 1.4}} onClick={() => setRating(3)}>3<i class="ri-star-fill"></i></motion.span>
                        <motion.span whileTap={{scale: 1.4}} onClick={() => setRating(4)}>4<i class="ri-star-fill"></i></motion.span>
                        <motion.span whileTap={{scale: 1.4}} onClick={() => setRating(5)}>5<i class="ri-star-fill"></i></motion.span>
                        <div>Rating Given - {rating}</div>
                      </div>
